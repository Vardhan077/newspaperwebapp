    ...
    mostReadFunc = item =>{
        ...
        return(
            <li>
                ...
                {/* <p className="sideRead">2 MIN READ</p> */}
            </li>
        )
    }
    ...
    render(){
        ...
        return(
            <div>
                ...
                <hr className="line lineT"/>
                {/* <div className="youShouldKnow">
                    <h1 className="second">EDITOR'S PICKS</h1>
                    <ul className="ysk">
                        {this.editorsPicksFun()}
                    </ul>
                </div> */}
...
//     try {
//       const url =
//         "https://newsapi.org/v2/everything?domains=wsj.com&apiKey=690db48467224d73b39d478ed4cc83a2";
//       const response = await fetch(url);
//       if (!response.ok) {
//         throw new Error("Failed to fetch data");
//       }
//       const data = await response.json();
//       const filteredArticles = data.articles.filter((item) => item.urlToImage);
//       const articles = filteredArticles.slice(2, 19);
...
//   render() {
//     const { list } = this.state;
//     const main = list.length > 0 ? list[0] : null;
...
//               <p className="read">7 MIN READ</p>
//               <p className="mainPublished">{main.publishedAt}</p>
//               <p className="mainDesc">{main.description}</p>
//             </Link>
//           )}
//           {main && (
//             <Link to="/main">
//               <img src={main.urlToImage} className="mainImg" alt="Main" />
//             </Link>
//           )}
//           <div className="mmmm">
//             <div className="mostRead">
...
//                   <li key={item.url}>
//                     <Link to={`/article/${encodeURIComponent(item.url)}`} className="mostReadLink">
//                       <p className="sideTitle">{item.title}</p>
//                       <p className="sideAuthor">{item.author}</p>
//                     </Link>
//                   </li>
//                 ))}
//               </ol>
...
//             <HomeItems key={item.url} item={item} id={encodeURIComponent(item.url)} />
//           ))}
//         </div>
//         <hr className="line lineT" />
//         <div className="youShouldKnow">
...
//             <ReactPlayer className="player" controls={true} pip={false} url="https://www.youtube.com/watch?v=KOEfDvr4DcQ" height="360px" width="640px" />
//           </div>
//           <h2 className="headingVid">Face Your Biggest Fear To Win $800,000</h2>
//           <div className="smallVid">
//             <ReactPlayer className="playerS" controls={true} pip={false} url="https://www.youtube.com/watch?v=Q6G5eYNPuiA" height="150px" width="270px" />
//             <h1 className="smallHeading">Indian bowlers with Most Test wickets | WION</h1>
//           </div>
